    ...
    public partial class First : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CivilRegestrations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClinicLabs", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bands_CurrentStates_CurrentStateId",
                        column: x => x.CurrentStateId,
                        principalTable: "CurrentStates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bands_Hospitals_HospitalId",
                        column: x => x.HospitalId,
                        principalTable: "Hospitals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClinicLabDoctors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClinicLabDoctors_ClinicLabs_ClinicLabId",
                        column: x => x.ClinicLabId,
                        principalTable: "ClinicLabs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClinicLabDoctors_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClinicLabDoctors_ClinicLabId",
                table: "ClinicLabDoctors",
                column: "ClinicLabId");

            migrationBuilder.CreateIndex(
                name: "IX_ClinicLabDoctors_DoctorId",
                table: "ClinicLabDoctors",
                column: "DoctorId");
